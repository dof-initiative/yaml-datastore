...
describe("Test basic clear function for empty element path pointing to an object", () => {
  ...
  it("shall clear object for empty element path where working directory is an object and its parent is an object", async () => {
    // 1. get spec case path
    const specCasePath = toSpecCasePath(
  ...
  it("shall clear object for empty element path where working directory is an object and its parent is a list", async () => {
    // 1. get spec case path
    const specCasePath = toSpecCasePath(
      path.join("2.2.3_list_of_objects_of_complex_data_types", "clearModel0")
    );
    const elementName = "model_E16F4F";
    const workingDirectoryPath = path.join(TMP_WORKING_DIR_PATH, elementName);
    const specCaseWorkingDirectoryPath = path.join(
      TMP_SPEC_DIR_AFTER_OPERATION_PATH
    );
    ...
    // 4. verify results of clear operation
    const expectedResult = load(specCaseWorkingDirectoryPath, "model", depth);
    const expectedParentElement = expectedResult.element;
    expect(result.success).to.equal(true);
    expect(toJsonString(result.element)).to.equal(
      toJsonString(expectedParentElement)
  ...
  it("shall clear object for empty element path where working directory is an object and its parent is a list nested in a list", async () => {
    // 1. get spec case path
    const specCasePath = toSpecCasePath(
      path.join(
    ...
    const elementName = "model_E16F4F_E16F4F";
    const workingDirectoryPath = path.join(TMP_WORKING_DIR_PATH, elementName);
    const specCaseWorkingDirectoryPath = path.join(
      TMP_SPEC_DIR_AFTER_OPERATION_PATH
    );
...
describe("Test basic clear function for short element path pointing to object", () => {
  ...
  it("shall clear object of complex data types from object for short element path to object where working directory is an object", async () => {
    ...
    const elementPathToClear = "myObj";
    const depth = 0;
...
describe("Test basic clear function for short element path pointing to list", () => {
  ...
  it("shall clear list of complex string for short element path to list where working directory is not an object", async () => {
    // 1. get spec case path
    const specCasePath = toSpecCasePath(
      path.join("2.2.1_list_of_complex_string", "clearModel")
    );
    const workingDirectoryPath = TMP_WORKING_DIR_PATH;
    const specCaseWorkingDirectoryPath = TMP_SPEC_DIR_AFTER_OPERATION_PATH;
    const elementPathToClear = "model";
  ...
  it("shall clear list of object for short element path to list where working directory is not an object", async () => {
    // 1. get spec case path
    const specCasePath = toSpecCasePath(
      path.join("2.2.2_list_of_objects_of_simple_data_types", "clearModel")
    );
    const workingDirectoryPath = TMP_WORKING_DIR_PATH;
    const specCaseWorkingDirectoryPath = TMP_SPEC_DIR_AFTER_OPERATION_PATH;
    const elementPathToClear = "model";
  ...
  it("shall clear list of list for short element path to list where working directory is not an object", async () => {
    // 1. get spec case path
    const specCasePath = toSpecCasePath(
      path.join("2.2.4_list_of_list_of_simple_data_type", "clearModel")
    );
    const workingDirectoryPath = TMP_WORKING_DIR_PATH;
    const specCaseWorkingDirectoryPath = TMP_SPEC_DIR_AFTER_OPERATION_PATH;
    const elementPathToClear = "model";
  ...
  it("shall clear list of simple data types for short element path to list where working directory is an object that is the parent element", async () => {
    // 1. get spec case path
    const specCasePath = toSpecCasePath(
      path.join(
    ...
    const elementPathToClear = "personInfo1";
    const depth = 0;
  ...
  it("shall clear list of complex string for short element path to list where working directory is an object that is the parent element", async () => {
    // 1. get spec case path
    const specCasePath = toSpecCasePath(
      path.join(
        "1.3.6_object_with_two_lists_of_complex_strings",
        "clearSecondTwoVerses"
      )
    );
    const parentElementName = "model";
    const workingDirectoryPath = path.join(
    ...
    const elementPathToClear = "secondTwoVerses_txt";
    const depth = 0;
  ...
  it("shall clear list of object for short element path to list where working directory is an object that is the parent element", async () => {
    // 1. get spec case path
    const specCasePath = toSpecCasePath(
      path.join(
        "1.3.7.1_object_with_two_lists_of_objects_of_simple_data_types",
        "clearNcc1701dCommanders"
      )
    );
    const parentElementName = "model";
    const workingDirectoryPath = path.join(
    ...
    const elementPathToClear = "ncc1701dCommanders";
    const depth = 0;
  ...
  it("shall clear list of list for short element path to list where working directory is an object that is the parent element", async () => {
    // 1. get spec case path
    const specCasePath = toSpecCasePath(
      path.join(
    ...
    const elementPathToClear = "second4Primes";
    const depth = 0;
...
describe("Test basic clear function for short element path pointing to complex string", () => {
  ...
  it("shall clear complex string from object for short element path to complex string where working directory is an object", async () => {
    // 1. get spec case path
    const specCasePath = toSpecCasePath(
    ...
    const elementPathToClear = "lyrics_txt";
    const depth = 0;
...
describe("Test basic clear function for short element path pointing to simple data type", () => {
  ...
  it("shall clear simple data types from object for short element path to element where working directory is an object", async () => {
    const elementPaths = [
    ...
    for (const elementPathToClear of elementPaths) {
      const expectedRootElementSpec =
        "clear" +
        elementPathToClear.charAt(0).toUpperCase() +
        elementPathToClear.slice(1);
